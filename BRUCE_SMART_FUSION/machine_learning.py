...
class machine_learning:
    def __init__(
        ...
        if self.feature_selector.lower() == "freq":
            ...
            self.y = feature_metrics[
                ["error_hrv", "error_rpeak", "error_adr", "patient_id"]
            ]
    ...
    def patient_wise_split(self):
        ...
        if self.feature_selector.lower() == "freq":
            ...
            x_train = np.hstack(
                (x_train, self.feature_metrics[split_1, 21].reshape(-1, 1))
            )
            y_train = self.feature_metrics[split_1, 22:26]
            x_test = self.feature_metrics[split_2, 0:9]
            x_test = np.hstack(
                (x_test, self.feature_metrics[split_2, 21].reshape(-1, 1))
            )
    ...
    def ridge_regression(self):
        ...
        for i in range(len(lamda)):
            ...
            predictions_hrv = cross_val_predict(
                regressor_hrv, x_train_hrv, y_train_hrv, cv=5
            )
            predictions_rpeak = cross_val_predict(
                regressor_rpeak, x_train_rpeak, y_train_rpeak, cv=5
            )
            predictions_adr = cross_val_predict(
                regressor_adr, x_train_adr, y_train_adr, cv=5
            )
        ...
        return (
            ...
            y_predict_rpeak_new,
            y_predict_adr_new,
        )  # ,error_hrv_new,error_rpeak_new,error_adr_new
    ...
    def cross_val_randomforest(self):
        ...
        rf_random_hrv = RandomizedSearchCV(
            estimator=regressor_hrv,
        ...
        rf_random_rpeak = RandomizedSearchCV(
            estimator=regressor_rpeak,
            param_distributions=random_grid,
            n_iter=10,
            cv=5,
            random_state=0,
        ...
        rf_random_adr = RandomizedSearchCV(
            estimator=regressor_adr,
            param_distributions=random_grid,
            n_iter=10,
            cv=5,
            random_state=0,
    ...
    def randomforest(self):
        ...
        if self.feature_selector.lower() == "freq":
            rf_reg_hrv_new = RandomForestRegressor(
                n_estimators=1100,
                min_samples_split=2,
                min_samples_leaf=10,
                bootstrap=False,
            ...
            rf_reg_rpeak_new = RandomForestRegressor(
                n_estimators=150,
            ...
            rf_reg_adr_new = RandomForestRegressor(
                n_estimators=150,
                min_samples_split=10,
                min_samples_leaf=10,
                bootstrap=True,
        ...
        return (
            ...
            y_predict_rpeak,
            y_predict_adr,
        )  # ,error_hrv,error_rpeak ,error_adr
    ...
    def cross_val_sup_vec(self):
        ...
        svr_random_hrv = RandomizedSearchCV(
            estimator=svr_reg_hrv,
            param_distributions=random_grid,
            n_iter=10,
            cv=5,
            random_state=0,
        ...
        svr_random_rpeak = RandomizedSearchCV(
            estimator=svr_reg_rpeak,
            param_distributions=random_grid,
            n_iter=10,
            cv=5,
            random_state=0,
        ...
        svr_random_adr = RandomizedSearchCV(
            estimator=svr_reg_adr,
            param_distributions=random_grid,
            n_iter=10,
            cv=5,
            random_state=0,
        ...
        svr_random_hrv_new = RandomizedSearchCV(
            estimator=svr_reg_hrv_new,
            param_distributions=grid_hrv_new,
            n_iter=10,
            cv=5,
            random_state=0,
            scoring=scorer,
        )
        svr_random_rpeak_new = RandomizedSearchCV(
            estimator=svr_reg_rpeak_new,
            param_distributions=grid_rpeak_new,
            n_iter=10,
            cv=5,
            random_state=0,
            scoring=scorer,
        )
        svr_random_adr_new = RandomizedSearchCV(
            estimator=svr_reg_adr_new,
            param_distributions=grid_adr_new,
            n_iter=10,
            cv=5,
            random_state=0,
            scoring=scorer,
    ...
    def supportvector(self):
        ...
        if self.feature_selector.lower() == "freq":
            svr_hrv_new = SVR(kernel="rbf", C=2.82842712, gamma=5.65685425)
            svr_rpeak_new = SVR(kernel="rbf", C=2.82842712, gamma=9.51365692)
            svr_adr_new = SVR(kernel="rbf", C=2.82842712, gamma=9.51365692)
        elif self.feature_selector.lower() == "morph":
            svr_hrv_new = SVR(kernel="rbf", C=2.37834142, gamma=4.75682846)
            svr_rpeak_new = SVR(kernel="rbf", C=2.37834142, gamma=4.75682846)
            svr_adr_new = SVR(kernel="rbf", C=19.02731384, gamma=0.2102241)
        elif self.feature_selector.lower() == "freq_morph":
            svr_hrv_new = SVR(kernel="rbf", C=2.82842712, gamma=3.36358566)
            svr_rpeak_new = SVR(kernel="rbf", C=2.82842712, gamma= 3.36358566)
            svr_adr_new = SVR(kernel="rbf", C=19.02731384, gamma=0.2102241)
    ...
    def lasso_regression(self):
        ...
        for i in range(len(alpha)):
            ...
            predictions_hrv = cross_val_predict(
                lasso_reg_hrv, x_train_hrv, y_train_hrv, cv=5
            )
            predictions_rpeak = cross_val_predict(
                lasso_reg_rpeak, x_train_rpeak, y_train_rpeak, cv=5
            )
            predictions_adr = cross_val_predict(
                lasso_reg_adr, x_train_adr, y_train_adr, cv=5
            )
            mean_mse_hrv.append(mean_squared_error(predictions_hrv, y_train_hrv))
            mean_mse_rpeak.append(mean_squared_error(predictions_rpeak, y_train_rpeak))
            mean_mse_adr.append(mean_squared_error(predictions_adr, y_train_adr))
        ...
        lasso_reg_rpeak_new = Lasso(
            alpha=alpha_rpeak, positive=True, fit_intercept=False
        )
    ...
    def cross_val_bayesianridge(self):
        ...
        br_random_hrv = RandomizedSearchCV(
            estimator=bayesian__ridge_hrv,
        ...
        br_random_rpeak = RandomizedSearchCV(
            estimator=bayesian__ridge_rpeak,
            param_distributions=grid,
            n_iter=10,
            cv=5,
            random_state=0,
        ...
        br_random_adr = RandomizedSearchCV(
            estimator=bayesian__ridge_adr,
            param_distributions=grid,
            n_iter=10,
            cv=5,
            random_state=0,
    ...
    def bayesian_ridge(self):
        ...
        if self.feature_selector.lower() == "freq":
            bayesian__ridge_hrv = BayesianRidge(
                fit_intercept=True,
                n_iter=450,
                alpha_1=0.00048828125,
                alpha_2=7.62939453125e-06,
                lambda_1=0.0009765625,
                lambda_2=1.52587890625e-05,
            )
            bayesian__ridge_rpeak = BayesianRidge(
                fit_intercept=True,
                n_iter=170,
                alpha_1=0.0009765625,
                alpha_2=7.62939453125e-06,
                lambda_1=1.52587890625e-05,
            ...
            bayesian__ridge_rpeak = BayesianRidge(
                fit_intercept=False,
                n_iter=810,
                alpha_1=3.814697265625e-06,
                alpha_2=0.0001220703125,
                lambda_1=0.0009765625,
                lambda_2=0.0001220703125,
            )
            bayesian__ridge_adr = BayesianRidge(
                fit_intercept=True,
                n_iter=170,
        ...
        self.save_path(
            bayesian__ridge_rpeak, model_type="bRridge", modality="rpeak_amp"
        )
    ...
    def save_path(self, model_weights, model_type="rr", modality="hrv"):
        model_save_path = os.path.join(
            self.model_save_path, model_type + "_" + modality + ".pkl"
        )
