...
parser.add_argument(
    "--save_model_path", type=str, help="Path to saved model", default='/media/acrophase/pose1/charan/BR_Uncertainty/BRUCE_DATA_SET_ATTENTION/SAVED_BRUCE_MODEL_ATTN'
    ...
    if item == "confe":
        ...
        for epoch in range(num_epochs):
            ...
            if mean_loss < best_loss:
                ...
                model.save_weights(os.path.join(results_path, 'best_model_10'+str(1e-2)+'_'+str(1e-3)+'_'+str(num_epochs)+'.h5'))
