...
class BRUnet_ATT_EVI(tf.keras.Model):
    def __init__(self, in_channels):
        super(BRUnet_ATT_EVI,self).__init__()
        #in_channels = shape[1]
    ...
    def call (self,x,training = False):
        ...
        return  d10_ecg,attn1,attn2,attn3,attn4,attn5


class BRUnet_Multi_resp_ATT_EVI(tf.keras.Model):
    def __init__(self, in_channels):
        super(BRUnet_Multi_resp_ATT_EVI,self).__init__()
    ...
    def call(self,x, training = False):
        ...
        return d10_ecg,out_5,attn1,attn2,attn3,attn4,attn5,attn6,attn7,attn8,attn9

class BRUnet_Encoder_ATT_EVI(tf.keras.Model):
    def __init__(self,in_channels):
        super(BRUnet_Encoder_ATT_EVI, self).__init__()
    ...
    def call(self,x, training = False):
        ...
        out_4 = self.fc(attn4)
        out_5 = self.ev1(out_4)
        return out_5,attn1,attn2,attn3,attn4

class BRUnet_raw_ATT_EVI(tf.keras.Model):
    def __init__(self,in_channels):
        super(BRUnet_raw_ATT_EVI, self).__init__()
