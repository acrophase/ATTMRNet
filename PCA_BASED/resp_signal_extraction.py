...
flpB_low_ee , flpA_low_ee = low_pass(5,20,0.4)
flpB_med_ee , flpA_med_ee = low_pass(6,20,0.7)
flpB_high_ee , flpA_high_ee = low_pass(6,20,0.8)

fkern_lpB , fkern_lpA = low_pass(6,30,0.7)
...
acc_x = data['S15']['ACC']['ACC_X'] 
acc_y = data['S15']['ACC']['ACC_Y']
acc_z = data['S15']['ACC']['ACC_Z']       
resp = data['S15']['RESP']['RESP_DATA']
...
with open ("S15_adr.pkl" , "wb") as f:
    pkl.dump(adr , f)

with open ("S15_ref_resp.pkl" , "wb") as f:
    pkl.dump(ref_resp , f)
