...
class BRUnet_evi(tf.keras.Model):
    def __init__(self, in_channels):
        super(BRUnet_evi,self).__init__()
        #in_channels = shape[1]
...
class BRUnet_Multi_resp_evi(tf.keras.Model):
    def __init__(self, in_channels):
        super(BRUnet_Multi_resp_evi,self).__init__()
...
class BRUnet_Encoder_evi(tf.keras.Model):
    def __init__(self,in_channels):
        super(BRUnet_Encoder_evi, self).__init__()
...
class BRUnet_raw_evi(tf.keras.Model):
    def __init__(self,in_channels):
        super(BRUnet_raw_evi, self).__init__()
...
class BRUnet_raw_encoder_evi(tf.keras.Model):
    def __init__(self,in_channels):
        super(BRUnet_raw_encoder_evi,self).__init__()
...
class BRUnet_raw_multi_evi(tf.keras.Model):
    def __init__(self, in_channels):
        super(BRUnet_raw_multi_evi , self).__init__()
